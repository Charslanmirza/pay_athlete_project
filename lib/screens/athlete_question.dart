...
class AthleteQuestions extends StatefulWidget {
  const AthleteQuestions({Key? key}) : super(key: key);

  @override
  State<AthleteQuestions> createState() => _AthleteQuestionsState();
}

class _AthleteQuestionsState extends State<AthleteQuestions> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomTextFormField(
                          ...
                          textValidator: (value) {
                            if (value == null || value == '') {
                              return "Please Enter The Current School";
                            }
                        ...
                        CustomTextFormField(
                          ...
                          textValidator: (value) {
                            if (value == null || value == '') {
                              return "Please Enter The Sports";
                            }
                        ...
                        gap10,
                        CustomTextFormField(
                          labelText: "Level of athlete",
                          textValidator: (value) {
                            if (value == null || value == '') {
                              return "Please Enter The Level";
                            }
                            _athleteController.text = value;
                        ...
                        CustomTextFormField(
                          labelText:
                              "Types of NIL opportunities that intrest you",
                          textValidator: (value) {
                            if (value == null || value == '') {
                              return "Please Enter NIL";
                            }
                            _nilController.text = value;
