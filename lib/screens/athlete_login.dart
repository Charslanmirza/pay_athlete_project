...
class AthleteLogin extends StatefulWidget {
  const AthleteLogin({Key? key}) : super(key: key);

  @override
  State<AthleteLogin> createState() => _AthleteLoginState();
}

class _AthleteLoginState extends State<AthleteLogin> {
