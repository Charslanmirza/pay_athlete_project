...
import 'package:signup_with_provider/screens/athlete_login.dart';
...
class AthletesSignup extends StatefulWidget {
  const AthletesSignup({Key? key}) : super(key: key);

  @override
  State<AthletesSignup> createState() => _AthletesSignupState();
}

class _AthletesSignupState extends State<AthletesSignup> {
                        ...
                        CustomElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          const AthleteQuestions()));
                            },
                            text: "Athlete Create Account"),
                      ],
                    ),
                  ),
                  gap20,
                      ...
                      FlatButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const AthleteLogin()));
                        },
                        child: Text(
                          "Login",
                          style: TextStyle(
